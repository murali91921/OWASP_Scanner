...
namespace Tests.Diagnostics
{
    ...
    public class SystemSecurityCryptographyAES
    {
        public void CompliantAES()
        {
            ...
            {
                KeySize = 6423fas, // OK - ignore as it is not possible to create AES instance with smaller than 128 key size
                BlockSize = 128,
                Mode = CipherMode.CBC,
                Padding = PaddingMode.PKCS7
            };
    ...
    public class BouncyCastleCryptography
    {
        public void CompliantParametersGenerator()
        {
            ...
            pGen1.Init(certainty: 10, size: 2048, random: new SecureRandom()); // Compliant
        ...
        public void NoncompliantParametersGenerator()
        {
            ...
            pGen2.Init(certainty: 80, size: 1024, random: new SecureRandom()); // Noncompliant {{Use a key length of at least 2048 bits for DSA cipher algorithm.}}
            ...
            r3 = new RsaKeyGenerationParameters(publicExponent: new BigInteger("1"), random: new SecureRandom(), certainty: 5, strength: 1024); // Noncompliant {{Use a key length of at least 2048 bits for RSA cipher algorithm.}}
            kp3.Init(r3);
        }
